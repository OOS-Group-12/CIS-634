...
<div class="modal fade" id="status2">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_status.php">
                <div class="form-group">
                    <label for="status1" class="col-sm-3 control-label">Status</label>
                    <div class="col-sm-9">
                        <select name="status22" id="status22">
                            <option value="YES">ACTIVE</option>
                            <option value="NO">NOT ACTIVE</option>
                        </select>
                    </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" class="btn btn-success btn-flat" name="status2"><i class="fa fa-check-square-o"></i> Update</button>
              </form>
            </div>
        </div>
    </div>
