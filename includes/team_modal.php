    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Add New Team Mate</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="team_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="password" class="col-sm-3 control-label">About</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="profilelink" class="col-sm-3 control-label">Profile Link</label>
                    <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="team_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_about" class="col-sm-3 control-label">About</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_about" name="about">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="edit_profilelink" class="col-sm-3 control-label">Profile Link</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_profilelink" name="profilelink">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
