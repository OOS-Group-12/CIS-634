<?php
	include 'includes/session.php';
		...
		$voter = substr(str_shuffle($set), 0, 15);
                    ...
                    if(mail($to,$subject,"YOUR VOTER ID IS______ ".$message."___AND YOUR PASSWORD IS____".$_POST['password'],$headers)){
                        	echo "<script>alert('You are successfully register voterid send to registered mail check in inbox or spam');</script>";
                    }else
	...
	header('location: ../index.php');
		...
		$_SESSION['error'] = 'Success/Please Wait Admin is Reviewing your application';
				header('location: ../index.php');
	}
	header('location:../');
?>